...
export const seoRoutes: SeoRoute[] = [
  ...
  { path: "/writing", changefreq: "monthly", priority: 0.8 },
  { path: "/writing/leaders-and-effective-leadership", changefreq: "monthly", priority: 0.5 },
  { path: "/writing/farscape-intelligent-fiction", changefreq: "monthly", priority: 0.5 },
  { path: "/writing/apples-new-gravity", changefreq: "monthly", priority: 0.5 },
  { path: "/web-digital", changefreq: "monthly", priority: 0.8 },
  { path: "/about", changefreq: "monthly", priority: 0.8 },
  { path: "/communications", changefreq: "monthly", priority: 0.8 },
