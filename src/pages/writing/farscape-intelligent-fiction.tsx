...
const sample = getSample('farscape-intelligent-fiction')!;
const site = 'https://snwhip.com';
const url = `${site}/writing/farscape-intelligent-fiction`;
...
export default function FarscapeIntelligentFictionPage() {
  return <>
      <Helmet>
        <title>{title}</title>
